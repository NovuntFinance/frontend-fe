...
function generateMockActivity(): Activity {
    const firstNames = ['John', 'Sarah', 'Mike', 'Emma', 'David', 'Lisa', 'Tom', 'Anna'];
            ...
            <AnimatePresence mode="popLayout">
                {activities.slice(0, 1).map((activity) => (
                    <motion.div
                        ...
                        className="mb-2"
                    >
                        <div className="flex items-center gap-3 p-3 pr-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 backdrop-blur-sm">
                            {/* Icon */}
                            <div className={`flex items-center justify-center w-10 h-10 rounded-full ${getColor(activity.type)}`}>
