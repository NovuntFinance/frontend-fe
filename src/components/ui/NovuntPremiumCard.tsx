...
export function NovuntPremiumCard({
    ...
    return (
        <Card className={cn(
            "relative overflow-hidden border-border/50 bg-gradient-to-br from-card via-card to-muted/20 transition-all duration-300",
            className
        )}>
            {/* Background Glow Effect */}
            <div className={cn(
                "absolute top-0 left-0 w-full h-full bg-gradient-to-br pointer-events-none opacity-50",
                theme.glowFrom,
                "via-transparent",
                theme.glowTo
            )} />
