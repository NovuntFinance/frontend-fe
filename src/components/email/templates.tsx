                ...
                <tr>
                  <td className={styles.footerCell}>
                    ...
                    <p className={styles.footerText}>
                      © 2025 Novunt. All rights reserved.
                      <br />
...
export function VerificationEmail({
  ...
  return (
    <EmailTemplate preview="Your journey to financial freedom starts here ✨">
      ...
      >
        Every significant journey begins with a single, intentional step. Today,
        you&apos;ve chosen to take control of your financial future. That takes
        courage, and we&apos;re honored to walk alongside you.
      </p>
      ...
      >
        ...
        >
          You&apos;ll get instant access to your personal dashboard, unlock a{' '}
          <strong>10% welcome bonus</strong> on your first stake, and join a
          community that&apos;s already earned millions in returns.
        </p>
      </div>
...
export function PasswordResetEmail({
  ...
  return (
    <EmailTemplate preview="Let's get you back on track securely 🔐">
      ...
      >
        Forgot your password? It happens to everyone. Let&apos;s fix this
        together.
      </p>
      ...
      >
        Your account security is important to us. We received a request to reset
        your password. If this was you, simply click the button below to create
        a new, secure password and get back to building your wealth.
      </p>
      ...
      >
        ...
        >
          ...
          <span style={{ fontWeight: '700', color: '#f59e0b' }}>1 hour</span>
        </p>
      ...
      >
        ...
        >
          You&apos;ll be securely logged back into your account with instant
          access to all your stakes, earnings, and goals. Your financial journey
...
export function WelcomeEmail({ name }: { name: string }) {
  return (
    <EmailTemplate preview="Your financial freedom journey begins now 🚀">
      ...
      >
        Today marks the beginning of a journey that thousands have already
        started—and are winning at. Welcome to a community where your financial
        goals aren&apos;t just dreams, they&apos;re{' '}
        <strong style={{ color: '#1e3a8a' }}>plans in motion</strong>.
      </p>
      ...
      >
        ...
        >
          On your first stake—because we believe in rewarding bold moves.
          That&apos;s up to <strong>$10,000 extra</strong> working for you from
          day one.
        </p>
      </div>
      ...
      <div style={{ margin: '40px 0' }}>
        ...
        >
          ...
          <div style={{ display: 'table-cell', verticalAlign: 'top' }}>
            ...
            >
              Maybe it&apos;s building an emergency fund, saving for a dream
              vacation, or achieving financial independence. Name it. Claim it.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div style={{ display: 'table-cell', verticalAlign: 'top' }}>
            ...
            >
              Start with any amount from $1,000. Watch it work for you daily,
              earning up to <strong>200% returns</strong>. Your 10% bonus is
              waiting.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div style={{ display: 'table-cell', verticalAlign: 'top' }}>
            ...
            >
              Watch your wealth grow in real-time. Earn NXP points, unlock
              Premium Pools, and become part of the Novunt Legacy.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          <strong style={{ fontSize: '16px' }}>
            💡 You&apos;re joining 10,000+ stakeholders
          </strong>
          <br />
          who have already earned millions in returns through Novunt. Your
      ...
      >
        ...
        <br />
        The second best time is now.&quot; The second best time is{' '}
        <strong style={{ color: '#1e3a8a' }}>right now</strong>.&quot;
      </p>
...
export function TransactionEmail({
  ...
  const typeConfig = {
    deposit: {
      ...
      message:
        'Every great journey needs a starting point. You&apos;ve just taken the decisive step of funding your future. This isn&apos;t just money in an account—it&apos;s potential waiting to multiply.',
    ...
    withdrawal: {
      ...
      message:
        'This is what it&apos;s all about—turning goals into reality. Whether this withdrawal marks a milestone achieved or part of a bigger plan, you&apos;ve earned this moment.',
    ...
    stake: {
      ...
      message:
        'You&apos;ve committed capital to a goal that matters. From this moment, your money starts working around the clock—earning daily returns while you focus on what matters most in life.',
    ...
    reward: {
      ...
      message:
        'Success leaves clues, and you&apos;re finding them. This reward—whether from referrals, performance pools, or bonuses—proves that smart financial decisions compound in unexpected ways.',
    ...
    <EmailTemplate preview={`${transactionType} ${status} - ${amount}`}>
      ...
      {status === 'failed' && (
        ...
        >
          ...
          >
            Don&apos;t worry—these things happen. Our support team is standing
            by to help you resolve this quickly.
          </p>
          <a
            href="https://novunt.com/dashboard"
            style={{
      ...
      {status === 'success' && (
        ...
        >
          Every transaction brings you closer to your goals.
          <br />
