...
interface NxpOverviewProps {
  data?: NxpData | null;
  /** When false, only the NXP breakdown section is rendered (no status/overview card). Default true. */
  showOverviewCard?: boolean;
}

export function NxpOverview({
  data,
  ...
  return (
    ...
    >
        ...
        <div className={walletStyles.nxpMobileOnly}>
          <div className={walletStyles.nxpMobileCard}>
            <div className={walletStyles.nxpStatusBlock}>
              ...
              <span className={walletStyles.nxpStatusLabel}>
                CURRENT STATUS
              </span>
              ...
              <div className={walletStyles.nxpLevelBadge}>
                Level {nxp.level}
              </div>
            </div>
          ...
          <h2 className={walletStyles.nxpBreakdownTitleMobile}>
            NXP BREAKDOWN
          </h2>
          ...
          <div className={walletStyles.nxpOverviewCard}>
            ...
            <div className={walletStyles.nxpOverviewRight}>
              ...
              <div className={walletStyles.nxpOverviewNextValue}>
                ...
                <span className={walletStyles.nxpOverviewNextValueUnit}>
                  NXP
                </span>
              </div>
      ...
      {/* NXP Breakdown – when showOverviewCard=false, visible on all screens */}
      <div
        className={`${showOverviewCard ? walletStyles.nxpDesktopOnly : ''} ${walletStyles.nxpBreakdownDesktopWrap}`}
      >
