...
class AnalyticsManager {
    private providers: Array<VercelAnalytics | GoogleAnalytics | PlausibleAnalytics> = [];
...
export const AnalyticsEvents = {
    ...
    withdrawalCompleted: (amount: number, currency: string, transactionId: string) =>
        analytics.track('withdrawal_completed', { amount, currency, transactionId }),
